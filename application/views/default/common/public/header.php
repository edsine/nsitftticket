...
<head>
  ...
  ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php assets_path('css/app.css'); ?>">

    <base href="../../../" />
    <link rel="canonical" href="https://preview.keenthemes.com/metronic8" />
    <link rel="shortcut icon" href="<?php assets_path('assets/media/logos/favicon.ico'); ?>">
    <!--begin::Fonts(mandatory for all pages)-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700">
    <!--end::Fonts-->
    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link rel="stylesheet" type="text/css" href="<?php assets_path('assets/plugins/global/plugins.bundle.css'); ?>">
    <link rel="stylesheet" type="text/css" href="<?php assets_path('assets/css/style.bundle.css'); ?>">
    <!--end::Global Stylesheets Bundle-->


    <style>
      body {
        /* background-image: url('assetss/media/auth/Optimized-nsitf-login-img2.jpg'); */
...
<body>
          ...
          <ul class="navbar-nav d-block d-lg-flex auth-btns">
            ...
            ?>
              <li class="nav-item d-none d-lg-block">
                <a class="btn btn-z ms-lg-3 btn-wide" href="<?php echo env_url('login'); ?>"><?php echo lang('login'); ?></a>
              </li>
  ...
  ?>
    ...
    <script src="<?php assets_path('assets/plugins/global/plugins.bundle.js'); ?>"></script>
    <script src="<?php assets_path('assets/js/scripts.bundle.js'); ?>"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php assets_path('assets/js/custom/authentication/sign-in/general.js'); ?>"></script>
