...
$config['sess_cookie_name'] = 'z_session';
$config['sess_samesite'] = 'Lax';
$config['sess_expiration'] = 7200;

// Replace "ci_sessions" with "NULL" if "sess_driver" is assigned as "files".
...
$config['csrf_token_name'] = 'z_csrf';
$config['csrf_cookie_name'] = 'z_csrf_cookie';
